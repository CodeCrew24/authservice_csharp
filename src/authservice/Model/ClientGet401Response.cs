...
namespace authservice.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_client_get_401_response")]
    public partial class ClientGet401Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientGet401Response" /> class.
        /// </summary>
        /// <param name="message">Error message.</param>
        public ClientGet401Response(string message = default(string))
        {
